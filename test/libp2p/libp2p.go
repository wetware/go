...
//
//	mockgen -source=libp2p.go -destination=libp2p/libp2p.go -package=test_libp2p
//
...
func (mr *MockNetworkMockRecorder) CanDial(p, addr any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockEmitter) Emit(evt any) error {
	m.ctrl.T.Helper()
...
func (mr *MockEmitterMockRecorder) Emit(evt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDiscoveryMockRecorder) Advertise(ctx, ns any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, ns}, opts...)
...
func (mr *MockDiscoveryMockRecorder) FindPeers(ctx, ns any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, ns}, opts...)
