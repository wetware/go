...
// Package system_test is a generated GoMock package.
package system_test
...
func (m *MockAuthProvider) BindPolicy(user crypto.PubKey, policy system.Policy) error {
	m.ctrl.T.Helper()
...
func (mr *MockAuthProviderMockRecorder) BindPolicy(user, policy interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BindPolicy", reflect.TypeOf((*MockAuthProvider)(nil).BindPolicy), user, policy)
}
...
func (m *MockPolicy) NewStdio() (system.Socket, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewStdio")
	ret0, _ := ret[0].(system.Socket)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPolicy) SetStdio(arg0 system.Socket) error {
	m.ctrl.T.Helper()
...
func (m *MockPolicy) Stdio() (system.Socket, error) {
	m.ctrl.T.Helper()
